...
function dmrgs(H::MPO,H0::MPO,H1::MPO,H2::MPO,psi0::MPS, psi1::MPS, sweeps::Sweeps; kwargs...)
  ...
  Z2H = ProjMPO(H0)
  NN = ProjMPO(H2)
  return dmrgs(PH,PHH0,PH0,Z2H,NN,psi0,psi1,sweeps;kwargs...)
end
...
function dmrgs(PH,PHH0, PH0, Z2H, NN, psi0::MPS, psi1::MPS, sweeps::Sweeps; kwargs...)
  ...
  for sw=1:nsweep(sweeps)
       ...
       for (b, ha) in sweepnext(N)
            ...
            @timeit_debug timer "dmrg: eigsolve" begin
            vec, info =  linsolve(PH, bb, phi, ishermitian = ishermitian,
                                   maxiter = eigsolve_maxiter,
                                   krylovdim = eigsolve_krylovdim,
                                   issymmetric = true,
                                   isposdef = true,
