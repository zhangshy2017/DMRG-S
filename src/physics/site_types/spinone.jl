...
function op!(Op::ITensor, ::OpName"Sp2", ::SiteType"S=1", s::Index)
  return Op[s' => 1, s => 3] = 2.0
end


op!(Op::ITensor, ::OpName"S⁺", t::SiteType"S=1", s::Index) = op!(Op, OpName("S+"), t, s)

op!(Op::ITensor, ::OpName"Splus", t::SiteType"S=1", s::Index) = op!(Op, OpName("S+"), t, s)
...
function op!(Op::ITensor, ::OpName"Sm2", ::SiteType"S=1", s::Index)
  return Op[s' => 3, s => 1] = 2.0
end


op!(Op::ITensor, ::OpName"S⁻", t::SiteType"S=1", s::Index) = op!(Op, OpName("S-"), t, s)

op!(Op::ITensor, ::OpName"Sminus", t::SiteType"S=1", s::Index) = op!(Op, OpName("S-"), t, s)
...
op!(Op::ITensor, ::OpName"Sˣ", t::SiteType"S=1", s::Index) = op!(Op, OpName("Sx"), t, s)
...
op!(Op::ITensor, o::OpName, ::SiteType"SpinOne", s::Index) = op!(Op, o, SiteType("S=1"), s)
